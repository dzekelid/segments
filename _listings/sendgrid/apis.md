...
- name: SendGrid Get Contactdb Segments Segment  Recipients
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/segments/master/_listings/sendgrid/contactdb-segments-segment-id-recipients-get-postman.md
x-common:
- type: x-net-library
