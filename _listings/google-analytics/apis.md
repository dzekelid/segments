...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/segments/master/_listings/google-analytics/apis.md
specificationVersion: "0.14"
apis:
- name: Google Analytics - Get Segments
  x-api-slug: managementsegments-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/segments/master/_listings/google-analytics/managementsegments-get-openapi.md
- name: Google Analytics - Get Segments
  x-api-slug: managementsegments-get
  description: Lists segments to which the user has access.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/logo_lockup_analytics_icon_vertical_black_2x.png
